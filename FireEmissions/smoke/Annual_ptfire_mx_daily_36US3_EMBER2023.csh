...
setenv COSTCY "/proj/ie/proj/GSA-EMBER/BlueSky/from_EPA/ember_package/smoke/costcy_for_2017platform_08mar2023_nf_v8.txt"
...
#setenv GSREFTMP_F "${GE_DAT}/speciation/gsref_voc_2018_platform_21mar2023_nf_v8.txt"
...
setenv COSTCY "${GE_DAT}/costcy_for_2017platform_07dec2021_v2.txt"
...
setenv INVTABLE "${GE_DAT}/speciation/invtable_standard/invtable_2014platform_nointegrate_01may2019_v2.txt"
...
#setenv EMISINV_B "${CASEINPUTS}/ptfire_othna/ptinv_finn_MX_finn_2020_v25_na_ff10_22sep2022_v0.csv"
#setenv EMISINV_A "${CASEINPUTS}/ptfire_othna/ptinv_finn_CA_finn_2020_v25_na_ff10_Jan_Apr_21mar2023_v0.csv"
#setenv EMISDAY_B "${CASEINPUTS}/ptfire_othna/ptday_finn_MX_finn_2020_v25_na_ff10_csv_22sep2022_v0"
...
#setenv EMISDAY_A "${CASEINPUTS}/ptfire_othna/ptday_finn_CA_finn_2020_v25_na_ff10_csv_21mar2023_nf_v1"
#setenv EMISDAY_D1 "${CASEINPUTS}/ptfire_othna/2020ha_ptfire_Canada_fromECCC_May_Dec_daily_prevdec_21mar2023_v0"
#setenv EMISDAY_B1 "${CASEINPUTS}/ptfire_othna/ptday_finn_MX_finn_2020_v25_na_ff10_prevdec_csv_05oct2022_v0"
...
#setenv EMISDAY_C1 "${CASEINPUTS}/ptfire_othna/ptday_finn_ONA_finn_2020_v25_na_ff10_prevdec_csv_05oct2022_v0"
#setenv EMISDAY_C "${CASEINPUTS}/ptfire_othna/ptday_finn_ONA_finn_2020_v25_na_ff10_csv_22sep2022_v0"
#setenv EMISINV_C "${CASEINPUTS}/ptfire_othna/ptinv_finn_ONA_finn_2020_v25_na_ff10_22sep2022_v0.csv"
#setenv PTREF "${GE_DAT}/temporal/amptref_general_2014platform_tref_ptagfire_21mar2023_nf_v10"
#setenv EMISINV_D "${CASEINPUTS}/ptfire_othna/2020ha_ptfire_Canada_fromECCC_May_Dec_21mar2023_nf_v1.csv"
#setenv EMISDAY_D "${CASEINPUTS}/ptfire_othna/2020ha_ptfire_Canada_fromECCC_May_Dec_daily_21mar2023_nf_v1"

setenv PTREF "/proj/ie/proj/SMOKE/htran/Emission_Modeling_Platform/2022v1/ge_dat/temporal/tref_general_2022platform_09oct2024_v1"
setenv NHAPEXCLUDE "/proj/ie/proj/GSA-EMBER/BlueSky/ember_2024/smoke/scripts/nhapexclude_ember_2024.txt"
setenv GSREFTMP_A "/proj/ie/proj/GSA-EMBER/BlueSky/ember_2024/smoke/scripts/gsref_ptfire_othna_cmaq_cb6ae7_2022hc_cb6_22m_06apr2020_modi.txt"

setenv EMISINV_A "/proj/ie/proj/GSA-EMBER/BlueSky/FINN/finn2ff10/invens/ptinv_finn25_MX_finn25_2024_ff10.csv"
setenv EMISDAY_A "/proj/ie/proj/GSA-EMBER/BlueSky/FINN/finn2ff10/invens/ptday_finn25_MX_finn25_2024_ff10.csv"
...
setenv POLLUTANT_CONVERSION "N" ## Use pollutant conversion
...
setenv USE_FF10_DAILY_PTFIRE "Y" ## Use FF10 Daily Ptfire
setenv ELEV_WRITE_FAKE_SRC "Y" ## Write Dummy Fires
...
## Parameters -- all regions, sector (ptfire-rx), all jobs 
setenv ELEVPOINT_DAILY "Y" ## Ptfire Inline
setenv EMF_QUEUE_OPTIONS_C128 "--mem-per-cpu=128g -n 1 -p compute -A emis --gid=emis-hpc -t 168:00:00" ## EMF queue options - emis
setenv MET_ASM "N" ## Path, Met data root
setenv WRITE_ANN_ZERO "Y" ## Write zero emissions
...
setenv HOURLY_FIRE_YN "Y" ## Use hourly plume rise data
setenv ZIPOUT "Y" ## Zip POUT and INLN output files
setenv NONHAP_TYPE "NONHAPVOC" ## Nonhap Type
setenv SMK_PROCESS_HAPS "NONE" ## Use NHAPEXCLUDE file
setenv FIRE_BOTTOM_LAYER_1_YN "Y" ## Use corrected layer algorithm for fires
